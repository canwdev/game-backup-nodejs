  ...
  <dialog ref="editDialogRef" @close="resetEditForm">
    <form @submit.prevent="submitEditForm">
      ...
      <div class="form-grid">
        ...
        <div class="input-group">
          <input autocomplete="off" id="configName" v-model="editForm.name" placeholder="Unique name" required type="text">
        ...
        <template v-if="editForm.type === 'folder'">
          ...
          <div class="input-group">
            <input
              class="variable-input-target"
              autocomplete="off" id="srcPath" v-model="editForm.srcPath"
        ...
        <template v-else>
          ...
          <div class="input-group">
            <textarea
              class="variable-input-target"
              id="exclude" v-model="editForm._srcFiles"
        ...
        <div class="input-group">
          <input
            class="variable-input-target"
            autocomplete="off" id="destPath" v-model="editForm.destPath"
